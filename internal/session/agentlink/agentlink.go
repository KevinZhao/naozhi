...
// satisfies them via *subagent.Linker; other backends can plug a noop so
...
import "github.com/naozhi/naozhi/internal/subagent"
...
type Resolver interface {
	...
	Query(taskID string) (subagent.LinkInfo, bool)
	...
	QueryOrResolveFast(taskID string) (subagent.LinkInfo, bool)
}
...
// AgentLinker is the subset of *subagent.Linker the server consumes. A
// backend without a linker returns zero-valued subagent.LinkInfo and the server
// treats it as tombstone. subagent.LinkInfo is reused rather than mirrored:
