...
// job ("cron:<id>" orphan). Each failure branch participates in the P0
// run-history terminal protocol (broadcast cron_run_ended + counters +
// LastErrorClass write) via finishRun.
//
