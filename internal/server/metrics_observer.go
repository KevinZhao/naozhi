// metrics_observer.go: the server/wshub layer bumps process counters through
// the small serverMetricsObserver seam instead of touching internal/metrics
// expvar globals directly, so tests can swap in a counting fake via
// withServerMetrics (#582). Scoped to the counters this package touches.
package server
...
// corresponding internal/metrics expvar global.
...
// through. Tests reassign it via withServerMetrics and restore on cleanup.
