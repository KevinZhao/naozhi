...
// R229-CR-7: replyTracker + its lifecycle helpers extracted from
// dispatch.go to keep the main file focused on Dispatcher orchestration.
// The type and its methods stay package-private so dispatch.go can
// continue to mint trackers via newIMEventTracker.
