...
func TestEventLog_EntriesSinceAppend_EquivalentToEntriesSince(t *testing.T) {
	...
	for i, ts := range []int64{1000, 1500, 2000, 2500, 3000} {
		l.Append(clievent.EventEntry{Time: ts, Type: "user", Summary: string(rune('a' + i))})
	}
...
func TestEventLog_EntriesSinceAppend_ReusesBuffer(t *testing.T) {
	...
	pool := make([]clievent.EventEntry, 0, 16)
...
func TestEventLog_EntriesSinceAppend_EmptyContractMatchesEntriesSince(t *testing.T) {
	t.Parallel()
	l := NewEventLog(8)
	l.Append(clievent.EventEntry{Time: 1000, Type: "user"})
	...
	pool := make([]clievent.EventEntry, 0, 4)
...
func TestEventLog_EntriesBeforeAppend_EquivalentToEntriesBefore(t *testing.T) {
	...
	l := NewEventLog(16)
	for i := 1; i <= 10; i++ {
		l.Append(clievent.EventEntry{Time: int64(i * 1000), Type: "text"})
	}
...
func TestEventLog_EntriesBeforeAppend_LimitZeroContract(t *testing.T) {
	t.Parallel()
	l := NewEventLog(8)
	l.Append(clievent.EventEntry{Time: 1000, Type: "text"})
...
func TestEventLog_EntriesBeforeAppend_NoMatch(t *testing.T) {
	t.Parallel()
	l := NewEventLog(8)
	l.Append(clievent.EventEntry{Time: 5000, Type: "text"})
...
func TestEventLog_EntriesBefore_NonMonotonicTimeFiltersCorrectly(t *testing.T) {
	...
	l.Append(clievent.EventEntry{Time: 200, Type: "text", Summary: "t200"})
	l.Append(clievent.EventEntry{Time: 150, Type: "text", Summary: "t150"})
	l.Append(clievent.EventEntry{Time: 300, Type: "text", Summary: "t300"})
	l.Append(clievent.EventEntry{Time: 100, Type: "text", Summary: "t100"})
	...
	l2 := NewEventLog(8)
	l2.Append(clievent.EventEntry{Time: 600, Type: "text"})
	l2.Append(clievent.EventEntry{Time: 400, Type: "text"})
...
func TestEventLog_EntriesBeforeAppend_NonMonotonicTimeFiltersCorrectly(t *testing.T) {
	t.Parallel()
	l := NewEventLog(8)
	l.Append(clievent.EventEntry{Time: 200, Type: "text"})
	l.Append(clievent.EventEntry{Time: 150, Type: "text"})
	l.Append(clievent.EventEntry{Time: 300, Type: "text"})
	l.Append(clievent.EventEntry{Time: 100, Type: "text"})
