...
//   - ring.EventLog — eventlog*.go: in-memory ring buffer (default 500 entries)
//     the dashboard live-tails, plus the ring.PersistSink contract. The on-disk
...
// ring.EventLog observation API (Subscribe / EntriesSince / LastN). Unexported
