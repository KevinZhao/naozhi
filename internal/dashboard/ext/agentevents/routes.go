// routes.go — the /api/sessions agent-event surface this package owns (#2554).
//
...
func (h *Handler) Routes() []httputil.Route {
	return []httputil.Route{
		{Pattern: "GET /api/sessions/agent_events", Handler: h.HandleAgentEvents},
		{Pattern: "GET /api/sessions/tool_result", Handler: h.HandleToolResult},
	}
}
