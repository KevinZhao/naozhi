...
//     the reverse. Record.Entry is json.RawMessage precisely so this
//     package stays cli-agnostic; the persist + naozhilog layers above
//     own the cli.EventEntry (de)serialization.
//
